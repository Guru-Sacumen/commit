...
// const DEFAULT_LOGO =
//   'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="40" height="40"><rect width="40" height="40" rx="8" fill="%23e5e7eb"/><text x="50%" y="54%" dominant-baseline="middle" text-anchor="middle" font-size="10" fill="%236b7280">CX</text></svg>';
...
//       const requestRows = await connectorsApi.getTenantRequests(tenantId);
//       setRequests(requestRows || []);
...
//     // Keep first page window wide enough: 1,2,3,...
//     if (page <= 2) {
//       start = 2;
//       end = Math.min(pages - 1, 3);
//     }
//     // Keep last page window wide enough: ...,N-2,N-1,N
//     if (page >= pages - 1) {
...
//                       <img src={resolveAssetUrl(connector.logo_url) || DEFAULT_LOGO} alt={connector.name} />
//                     </div>
//                     <div>
...
//                   <div className="ib-card-header-left">
//                     <div className="ib-card-logo">
//                       <img src={resolveAssetUrl(request.logo_url) || DEFAULT_LOGO} alt={request.connector_name || request.connector_id} />
//                     </div>
//                     <div>
...
//                   <div className="ib-card-logo">
//                     <img
//                       src={resolveAssetUrl(connector.logo_url) || DEFAULT_LOGO}
//                       alt={connector.name}
//                     />
//                   </div>
//                   <div>
